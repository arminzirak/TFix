...
tokenizer = T5Tokenizer.from_pretrained(f'{args.load_model}')
print("Loaded tokenizer from directory {}".format(f'{args.load_model}'))
model = T5ForConditionalGeneration.from_pretrained(f'{args.load_model}')
print("Loaded model from directory {}".format(f'{args.load_model}'))

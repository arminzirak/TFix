...
#SBATCH --job-name=test-smA # single job name for the array
...
do
  echo $repo
  python hf_transformers/tfix_testing.py --load-model [] -bs 128 --model-name t5-small -d repo-based-included -r $repo
done